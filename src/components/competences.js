...
export const Competences=()=>{
    ...
    return(
        <section className="col-12 col-lg-11 col-xxl-6 mx-auto" id='competences'>
            <div className='bg-postIt-reverse'>
                <div className="post-it post-it-reverse">
                    ...
                    <ul className='hardSkillsList'>
                        <li>
                            <figure>
                                <img src={imgSql} alt="logo SQL" className="logoHardSkills "></img>
                    ...
                    <p className='competencePs'>Je vous invite à lire la fiche technique de la formation M2I que je suis <a href='https://drive.google.com/file/d/1gtnDqYZqLZfW_pZLaN8MPrXUgTF7dm4o/view?usp=sharing' target="_blank" rel="noreferrer">ici</a> .</p>
                </div>
            </div>
