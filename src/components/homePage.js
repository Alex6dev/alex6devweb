...
export const HomeComponent=()=>{   
    ...
    return(
        <section className="col-11 m-auto d-flex mt-5" >
            <div className='row'>
                <div className="containerImgLeft col-4 col-lg-3">
                ...
                <div className="containerTextStart col-8 col-lg-6">
                ...
                <div className="containerImgRight d-none d-lg-block col-lg-3">
